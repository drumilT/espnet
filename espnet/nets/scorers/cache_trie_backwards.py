...
class CacheTrieBackwardsbase(ABC):
...
class CacheTrieBackwardsFullScorer(CacheTrieBackwardsbase, BatchScorerInterface):
...
class CacheTrieBackwardsPartScorer(CacheTrieBackwardsbase, PartialScorerInterface):
